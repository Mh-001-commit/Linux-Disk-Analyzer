    ...
    1: [
      function (require, module, exports) {
        ...
        var HierarchicalPieChart = /** @class */ (function () {
           ...
           */
          HierarchicalPieChart.prototype.arcTween = function (
            arc,
            baseArc,
            targetArc
          ) {
            ...
            return function (d) {
              var level = _this.d3.interpolate(
                _this.getLevel(d, baseArc),
                _this.getLevel(d, targetArc)
              );
              var startDeg = _this.d3.interpolate(
                _this.getStartAngle(d, baseArc),
                _this.getStartAngle(d, targetArc)
              );
              var stopDeg = _this.d3.interpolate(
                _this.getStopAngle(d, baseArc),
                _this.getStopAngle(d, targetArc)
              );
           ...
           */
          HierarchicalPieChart.prototype.onClickArc = function (
            plotEl,
            arc,
            d
          ) {
            ...
            var targetArc = d;
            if (
              d == this.arcClickHistory.current() &&
              this.arcClickHistory.size() > 1
            ) {
              revert = true;
            ...
            svg
              ...
              .transition()
              .duration(1000)
              .attrTween("d", this.arcTween(arc, baseArc, targetArc));
            setTimeout(function () {
          ...
          HierarchicalPieChart.prototype.processData = function (
            data,
            level,
            startAngle,
            stopAngle,
